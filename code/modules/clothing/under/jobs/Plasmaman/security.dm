...
/obj/item/clothing/under/plasmaman/security/warden
	name = "Knight-Sergeant plasma envirosuit"
	desc = "A plasmaman containment suit designed for the Knight-Sergeant, white stripes being added to differeciate them from other members of security."
