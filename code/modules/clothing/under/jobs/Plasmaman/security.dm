...
/obj/item/clothing/under/plasmaman/security/warden
	name = "Commissar plasma envirosuit"
	desc = "A plasmaman containment suit designed for the Commissar, white stripes being added to differeciate them from other members of security."
