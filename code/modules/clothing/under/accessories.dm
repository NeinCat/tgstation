...
/obj/item/clothing/accessory/medal/attack(mob/living/carbon/human/M, mob/living/user)
	if(ishuman(M) && (user.a_intent == INTENT_HELP))
		...
		if(M.w_uniform)
			...
			var/input
			if(!commended && user != M)
				input = stripped_input(user,"Please input a reason for this commendation, it will be recorded by Empire.", ,"", 140)
...
/obj/item/clothing/accessory/medal/silver/security
	...
	desc = "An award for distinguished combat and sacrifice in defence of Empire's commercial interests. Often awarded to security staff."

/obj/item/clothing/accessory/medal/silver/excellence
	name = "the Prefect Pretorio award for outstanding achievement in the field of excellence"
	desc = "Empire's dictionary defines excellence as \"the quality or condition of being excellent\". This is awarded to those rare crewmembers who fit that definition."
