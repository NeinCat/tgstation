...
/obj/item/paper/pamphlet/gateway
	info = "<b>Welcome to the Empire Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the Empire Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the Empire Gateway project. All away destinations have \
			been fully scanned by a Empire expeditionary team, and are certified to be 100% safe. \
			We've even left a case of space beer along with the basic materials you'll need to expand \
			Empire's operational area and start your new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All Empire approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the Empire Gateway Project, you will be on the frontiers of space. \
