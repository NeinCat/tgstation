...
/datum/station_goal/proc/send_report()
	priority_announce("Priority Empire directive received. Project \"[name]\" details inbound.", "Incoming Priority Message", 'sound/ai/commandreport.ogg')
	print_command_report(get_report(),"Empire Directive [pick(GLOB.phonetic_alphabet)] \Roman[rand(1,50)]", announce=FALSE)
	on_report()
