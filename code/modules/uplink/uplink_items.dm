...
/datum/uplink_item/dangerous/flamethrower
	name = "Flamethrower"
	desc = "A flamethrower, fueled by a portion of highly flammable biotoxins stolen previously from Empire \
...
/datum/uplink_item/support/reinforcement/saboteur_borg
	...
	desc = "A streamlined engineering cyborg, equipped with covert modules. Also incapable of leaving the welder in the shuttle. \
			...
			Its chameleon projector lets it disguise itself as a Empire cyborg, on top it has thermal vision and a pinpointer."
...
/datum/uplink_item/suits/space_suit
	...
	desc = "This red and black Syndicate space suit is less encumbering than Empire variants, \
			fits inside bags, and has a weapon slot. Empire crew members are trained to report red space suit \
			sightings, however."
...
/datum/uplink_item/suits/hardsuit
	...
	desc = "The feared suit of a Syndicate nuclear agent. Features slightly better armoring and a built in jetpack \
			...
			Empire crew who spot these suits are known to panic."
...
/datum/uplink_item/device_tools/magboots
	...
	desc = "A pair of magnetic boots with a Syndicate paintjob that assist with freer movement in space or on-station \
			during gravitational generator failures. These reverse-engineered knockoffs of Empire's \
...
/datum/uplink_item/device_tools/fakenucleardisk
	...
	desc = "It's just a normal disk. Visually it's identical to the real deal, but it won't hold up under closer scrutiny by the Governor. \
...
/datum/uplink_item/device_tools/rad_laser
	...
	desc = "A radioactive microlaser disguised as a standard Empire health analyzer. When used, it emits a \
...
/datum/uplink_item/badass/costumes/centcom_official
	...
	desc = "Ask the crew to \"inspect\" their nuclear disk and weapons system, and then when they decline, pull out a fully automatic rifle and gun down the Governor. \
