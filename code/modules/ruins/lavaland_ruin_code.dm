...
/obj/effect/mob_spawn/human/lavaland_syndicate
	...
	flavour_text = "Unfortunately, your hated enemy, Empire, has begun mining in this sector. Continue your research as best you can, and try to keep a low profile."
...
/obj/effect/mob_spawn/human/lavaland_syndicate/comms
	...
	flavour_text = "Unfortunately, your hated enemy, Empire, has begun mining in this sector. Monitor enemy activity as best you can, and try to keep a low profile. Use the communication equipment to provide support to any field agents, and sow disinformation to throw Empire off your trail. Do not let the base fall into enemy hands!"
...
/obj/effect/mob_spawn/human/lavaland_syndicate/comms/space
	...
	flavour_text = "Monitor enemy activity as best you can, and try to keep a low profile. Monitor enemy activity as best you can, and try to keep a low profile. Use the communication equipment to provide support to any field agents, and sow disinformation to throw Empire off your trail. Do not let the base fall into enemy hands!"
	important_info = "DO NOT abandon the base."
