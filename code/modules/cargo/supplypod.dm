...
/obj/item/disk/cargo/bluespace_pod //Disk that can be inserted into the Express Console to allow for Advanced Bluespace Pods
	...
	desc = "This disk provides a firmware update to the Express Supply Console, granting the use of Empire's Bluespace Drop Pods to the supply department."
