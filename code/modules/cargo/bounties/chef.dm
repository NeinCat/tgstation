/datum/bounty/item/chef/birthday_cake
	name = "Birthday Cake"
	description = "Empire's birthday is coming up! Ship them a birthday cake to celebrate!"
	reward = 4000
...
/datum/bounty/item/chef/soup
	name = "Soup"
	description = "To quell the homeless uprising, Empire will be serving soup to all underpaid workers. Ship any type of soup."
	reward = 3000
	required_count = 3
...
/datum/bounty/item/chef/onionrings
	name = "Onion Rings"
	description = "Empire is remembering Saturn day. Ship onion rings to show the station's support."
	reward = 3000
	required_count = 3
...
/datum/bounty/item/chef/poppypretzel
	name = "Poppy Pretzel"
	description = "Imperial Senate needs a reason to fire their HR head. Send over a poppy pretzel to force a failed drug test."
	reward = 3000
...
/datum/bounty/item/chef/hotdog
	name = "Hot Dog"
	description = "Empire is conducting taste tests to determine the best hot dog recipe. Ship your station's version to participate."
	reward = 8000
...
/datum/bounty/item/chef/chawanmushi
	name = "Chawanmushi"
	description = "Empire wants to improve relations with its sister company, Japanotrasen. Ship Chawanmushi immediately."
	reward = 8000
...
/datum/bounty/item/chef/pancakes
	name = "Pancakes"
	description = "Here at Empire we consider employees to be family. And you know what families love? Pancakes. Ship a baker's dozen."
	reward = 5000
	required_count = 13
