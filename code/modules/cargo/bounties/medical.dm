...
/datum/bounty/item/medical/lung
	name = "Lungs"
	description = "A recent explosion at Imperial Senate has left multiple staff with punctured lungs. Ship spare lungs to be rewarded."
	reward = 10000
	required_count = 3
...
/datum/bounty/item/medical/appendix
	name = "Appendix"
	description = "Chef Gibb of Imperial Senate wants to prepare a meal using a very special delicacy: an appendix. If you ship one, he'll pay."
...
/datum/bounty/item/medical/lizard_tail
	name = "Lizard Tail"
	description = "The Wizard Federation has made off with Empire's supply of lizard tails. While CentCom is dealing with the wizards, can the station spare a tail of their own?"
	reward = 3000
	wanted_types = list(/obj/item/organ/tail/lizard)

/datum/bounty/item/medical/cat_tail
	name = "Cat Tail"
	description = "Imperial Senate has run out of heavy duty pipe cleaners. Can you ship over a cat tail to help us out?"
	reward = 3000
