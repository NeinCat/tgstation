...
/datum/bounty/item/science/cryostasis_beaker
	...
	description = "Chemists at Empire Senate have discovered a new chemical that can only be held in cryostasis beakers. The only problem is they don't have any! Rectify this to receive payment."
	reward = 10000
	wanted_types = list(/obj/item/reagent_containers/glass/beaker/noreact)

/datum/bounty/item/science/diamond_drill
	name = "Diamond Mining Drill"
	description = "Empire Senate is willing to pay three months salary in exchange for one diamond mining drill."
	reward = 15000
