...
/datum/bounty/item/mining/skull_helmet
	name = "Skull Helmet"
	description = "Station 42's Commander has her birthday tomorrow! We want to suprise her with a fashionable skull helmet."
	reward = 4000
...
/datum/bounty/item/mining/bone_dagger
	name = "Bone Daggers"
	description = "Imperial Senate's canteen is undergoing budget cuts. Ship over some bone daggers so our Chef can keep working."
	reward = 5000
	required_count = 3
