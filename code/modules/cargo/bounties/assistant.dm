...
/datum/bounty/item/assistant/toolbox
	name = "Toolboxes"
	description = "There's an absence of robustness at Empire Senate. Hurry up and ship some toolboxes as a solution."
	reward = 2000
	required_count = 6
...
/datum/bounty/item/assistant/statue
	name = "Statue"
	description = "Empire Senate would like to commision an artsy statue for the lobby. Ship one out, when possible."
	reward = 2000
...
/datum/bounty/item/assistant/briefcase
	name = "Briefcase"
	description = "Empire Senate will be holding a business convention this year. Ship a few briefcases in support."
	reward = 2500
	required_count = 5
...
/datum/bounty/item/assistant/potted_plants
	name = "Potted Plants"
	description = "Empire Senate is looking to commission a new BirdBoat-class station. You've been ordered to supply the potted plants."
	reward = 2000
	required_count = 8
...
/datum/bounty/item/assistant/earmuffs
	name = "Earmuffs"
	description = "Empire Senate is getting tired of your station's messages. They've ordered that you ship some earmuffs to lessen the annoyance."
	reward = 1000
	wanted_types = list(/obj/item/clothing/ears/earmuffs)

/datum/bounty/item/assistant/handcuffs
	name = "Handcuffs"
	description = "A large influx of escaped convicts have arrived at Empire Senate. Now is the perfect time to ship out spare handcuffs (or restraints)."
	reward = 1000
	required_count = 5
...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, Empire Senate is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/bonfire
	name = "Lit Bonfire"
	description = "Space heaters are malfunctioning and the cargo crew of Empire Senate is starting to feel cold. Ship a lit bonfire to warm them up."
	reward = 5000
