/datum/bounty/item/assistant/strange_object
	name = "Strange Object"
	description = "Empire has taken an interest in strange objects. Find one in maint, and ship it off to CentCom right away."
	reward = 1200
	wanted_types = list(/obj/item/relic)

/datum/bounty/item/assistant/scooter
	name = "Scooter"
	description = "Empire has determined walking to be wasteful. Ship a scooter to CentCom to speed operations up."
...
/datum/bounty/item/assistant/skateboard
	name = "Skateboard"
	description = "Empire has determined walking to be wasteful. Ship a skateboard to CentCom to speed operations up."
...
/datum/bounty/item/assistant/toolbox
	name = "Toolboxes"
	description = "There's an absence of robustness at Imperial Senate. Hurry up and ship some toolboxes as a solution."
	reward = 2000
	required_count = 6
...
/datum/bounty/item/assistant/statue
	name = "Statue"
	description = "Imperial Senate would like to commision an artsy statue for the lobby. Ship one out, when possible."
	reward = 2000
...
/datum/bounty/item/assistant/briefcase
	name = "Briefcase"
	description = "Imperial Senate will be holding a business convention this year. Ship a few briefcases in support."
	reward = 2500
	required_count = 5
...
/datum/bounty/item/assistant/potted_plants
	name = "Potted Plants"
	description = "Imperial Senate is looking to commission a new BirdBoat-class station. You've been ordered to supply the potted plants."
	reward = 2000
	required_count = 8
...
/datum/bounty/item/assistant/earmuffs
	name = "Earmuffs"
	description = "Imperial Senate is getting tired of your station's messages. They've ordered that you ship some earmuffs to lessen the annoyance."
	reward = 1000
	wanted_types = list(/obj/item/clothing/ears/earmuffs)

/datum/bounty/item/assistant/handcuffs
	name = "Handcuffs"
	description = "A large influx of escaped convicts have arrived at Imperial Senate. Now is the perfect time to ship out spare handcuffs (or restraints)."
	reward = 1000
	required_count = 5
...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, Imperial Senate is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/ied
	name = "IED"
	description = "Empire's maximum security prison at CentCom is undergoing personnel training. Ship a handful of IEDs to serve as a training tools."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/bonfire
	name = "Lit Bonfire"
	description = "Space heaters are malfunctioning and the cargo crew of Imperial Senate is starting to feel cold. Ship a lit bonfire to warm them up."
	reward = 5000
