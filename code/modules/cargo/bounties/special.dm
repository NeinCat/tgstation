/datum/bounty/item/alien_organs
	name = "Alien Organs"
	description = "Empire is interested in studying Xenomorph biology. Ship a set of organs to be thoroughly compensated."
	reward = 25000
	required_count = 3
...
/datum/bounty/item/adamantine
	name = "Adamantine"
	description = "Empire's anomalous materials division is in desparate need for Adamantine. Send them a large shipment and we'll make it worth your while."
	reward = 35000
	required_count = 10
