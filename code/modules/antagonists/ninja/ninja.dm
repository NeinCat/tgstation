...
/datum/antagonist/ninja/proc/addMemories()
	...
	antag_memory += "Officially, [helping_station?"Empire":"The Syndicate"] are my employer.<br>"
...
/datum/antagonist/ninja/greet()
	...
	to_chat(owner.current, "Officially, [helping_station?"Empire":"The Syndicate"] are my employer.")
...
/datum/antagonist/ninja/admin_add(datum/mind/new_owner,mob/admin)
	var/adj
	switch(input("What kind of ninja?", "Ninja") as null|anything in list("Random","Syndicate","Empire","No objectives"))
		if("Random")
