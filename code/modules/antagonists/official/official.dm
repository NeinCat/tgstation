...
/datum/antagonist/official/greet()
	...
	if (ert_team)
		to_chat(owner, "Empire Senate is sending you to [station_name()] with the task: [ert_team.mission.explanation_text]")
	else
		to_chat(owner, "Empire Senate is sending you to [station_name()] with the task: [mission.explanation_text]")
