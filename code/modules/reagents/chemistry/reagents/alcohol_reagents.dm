...
/datum/reagent/consumable/ethanol/screwdrivercocktail/on_mob_life(mob/living/carbon/M)
	var/static/list/increased_rad_loss = list("Station Engineer", "Atmospheric Technician", "Prefect Fectum")
...
/datum/reagent/consumable/ethanol/grog
	name = "Grog"
	description = "Watered-down rum, Empire approves!"
	color = "#664300" // rgb: 102, 67, 0
...
/datum/reagent/consumable/ethanol/acid_spit
	...
	glass_desc = "A drink from Empire. Made from live aliens."

/datum/reagent/consumable/ethanol/amasec
	name = "Amasec"
	description = "Official drink of the Empire Gun-Club!"
	color = "#664300" // rgb: 102, 67, 0
	boozepwr = 35
	quality = DRINK_GOOD
...
/datum/reagent/consumable/ethanol/atomicbomb
	...
	glass_desc = "Empire cannot take legal responsibility for your actions after imbibing."
...
/datum/reagent/consumable/ethanol/bastion_bourbon/on_mob_metabolize(mob/living/L)
	...
	L.visible_message("<span class='warning'>[L] shivers with renewed vigor!</span>", "<span class='notice'>One taste of [r_lowertext(name)] fills you with energy!</span>")
...
/datum/reagent/consumable/ethanol/between_the_sheets
	...
	glass_desc = "The only drink that comes with a label reminding you of Empire's zero-tolerance promiscuity policy."
