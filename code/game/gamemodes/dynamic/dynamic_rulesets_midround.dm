...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Vigilia", "Commissar","Detective","Prefect Vigilum", "Governor", "Scientist", "Chemist", "Prefect Scientia", "Prefect Fectum")
...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list("Vigilia","Detective","Prefect Vigilum", "Governor")
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list("AI", "Cyborg", "Vigilia", "Commissar","Detective","Prefect Vigilum", "Governor")
