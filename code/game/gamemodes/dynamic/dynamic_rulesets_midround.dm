...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Security Officer", "Warden","Detective","Prefect Vigilum", "Proconsul", "Scientist", "Chemist", "Prefect Scientia", "Prefect Fectum")
...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list("Security Officer","Detective","Prefect Vigilum", "Proconsul")
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list("AI", "Cyborg", "Security Officer", "Warden","Detective","Prefect Vigilum", "Proconsul")
