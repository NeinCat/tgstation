...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Templar", "Knight-Sergeant","Detective","Commander", "Governor", "Scientist", "Chemist", "Prefect Scientia", "Prefect Fectum")
...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list("Templar","Detective","Commander", "Governor")
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list("AI", "Cyborg", "Templar", "Knight-Sergeant","Detective","Commander", "Governor")
