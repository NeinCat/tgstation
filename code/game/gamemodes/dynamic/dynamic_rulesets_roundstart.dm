...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list("Prisoner","Security Officer", "Warden", "Detective", "Prefect Vigilum", "Proconsul")
...
/datum/dynamic_ruleset/roundstart/wizard
	...
	restricted_roles = list("Prefect Vigilum", "Proconsul") // Just to be sure that a wizard getting picked won't ever imply a Proconsul or HoS not getting drafted
	required_candidates = 1
	weight = 2
	cost = 30
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Security Officer", "Warden", "Detective", "Prefect Vigilum", "Proconsul", "Chaplain", "Prefect Pretorio")
	required_candidates = 2
	weight = 3
	cost = 35
...
/datum/dynamic_ruleset/roundstart/nuclear
	...
	minimum_required_age = 14
	restricted_roles = list("Prefect Vigilum", "Proconsul") // Just to be sure that a nukie getting picked won't ever imply a Proconsul or HoS not getting drafted
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Security Officer", "Warden", "Detective", "Prefect Vigilum", "Proconsul", "Prefect Pretorio", "Prefect Fectum", "Prefect Medicus", "Prefect Scientia")
...
/datum/dynamic_ruleset/roundstart/devil
	...
	restricted_roles = list("Lawyer", "Curator", "Chaplain", "Prisoner", "Prefect Vigilum", "Proconsul", "AI")
	required_candidates = 1
	weight = 3
	cost = 0
	requirements = list(101,101,101,101,101,101,101,101,101,101)
