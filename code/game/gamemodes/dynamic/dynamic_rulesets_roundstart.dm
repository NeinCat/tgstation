...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list("Prisoner","Vigilia", "Commissar", "Detective", "Prefect Vigilum", "Proconsul")
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Vigilia", "Commissar", "Detective", "Prefect Vigilum", "Proconsul", "Chaplain", "Prefect Pretorio")
	required_candidates = 2
	weight = 3
	cost = 35
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Vigilia", "Commissar", "Detective", "Prefect Vigilum", "Proconsul", "Prefect Pretorio", "Prefect Fectum", "Prefect Medicus", "Prefect Scientia")
