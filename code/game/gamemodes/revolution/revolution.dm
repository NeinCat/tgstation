...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Prisoner","Templar", "Knight-Sergeant", "Detective", "AI", "Cyborg","Governor", "Prefect Pretorio", "Commander", "Prefect Fectum", "Prefect Scientia", "Prefect Medicus")
	required_jobs = list(list("Governor"=1),list("Prefect Pretorio"=1),list("Commander"=1),list("Prefect Fectum"=1),list("Prefect Scientia"=1),list("Prefect Medicus"=1)) //Any head present
	required_players = 30
	required_enemies = 2
...
/datum/game_mode/revolution/generate_report()
	return "Employee unrest has spiked in recent weeks, with several attempted mutinies on heads of staff. Some crew have been observed using flashbulb devices to blind their colleagues, \
		...
		your heads of staff are fully authorized to execute them using lethal weaponry - they will be later cloned and interrogated at Imperial Senate."
