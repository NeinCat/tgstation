...
/datum/game_mode/traitor/internal_affairs
	...
	reroll_friendly = 0
	traitor_name = "Empire Internal Affairs Agent"
	...
	announce_text = "There are Empire Internal Affairs Agents trying to kill each other!\n\
...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "Empire denies any accusations of placing internal affairs agents onboard your station to eliminate inconvenient employees.  Any further accusations against CentCom for such \
