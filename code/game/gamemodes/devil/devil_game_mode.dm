/datum/game_mode/devil
	...
	protected_jobs = list("Prisoner", "Lawyer", "Curator", "Chaplain", "Prefect Vigilum", "Proconsul", "AI")
	required_players = 0
	required_enemies = 1
...
/datum/game_mode/devil/generate_report()
	return "Infernal creatures have been seen nearby offering great boons in exchange for souls.  This is considered theft against Empire, as all employment contracts contain a lien on the \
