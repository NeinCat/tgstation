...
/obj/structure/sign/plaques/golden/captain
	name = "The Most Robust Governor Award for Robustness"
...
/obj/structure/sign/plaques/kiddie/perfect_man
	...
	desc = "A guide to the exhibit, explaining how recent developments in mindshield implant and cloning technologies by Empire Corporation have led to the development and the effective immortality of the 'perfect man', the loyal Empire Employee."
