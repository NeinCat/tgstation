...
/obj/structure/showcase/mecha/marauder
	...
	desc = "A stand with an empty old Empire Corporation combat mech bolted to it. It is described as the premier unit used to defend corporate interests and employees."
...
/obj/structure/showcase/machinery/implanter
	name = "\improper Empire automated mindshield implanter exhibit"
	desc = "A flimsy model of a standard Empire automated mindshield implant machine. With secure positioning harnesses and a robotic surgical injector, brain damage and other serious medical anomalies are now up to 60% less likely!"
	icon = 'icons/obj/machines/implantchair.dmi'
	icon_state = "implantchair"

/obj/structure/showcase/machinery/microwave
	name = "\improper Empire-brand microwave"
	desc = "The famous Empire-brand microwave, the multi-purpose cooking appliance every station needs! This one appears to be drawn onto a cardboard box."
...
/obj/structure/showcase/perfect_employee
	...
	desc = "A stand with a model of the perfect Empire Employee bolted to it. Signs indicate it is robustly genetically engineered, as well as being ruthlessly loyal."

/obj/structure/showcase/machinery/tv
	name = "\improper Empire corporate newsfeed"
	desc = "A slightly battered looking TV. Various Empire infomercials play on a loop, accompanied by a jaunty tune."
	icon = 'icons/obj/computer.dmi'
