...
/obj/item/encryptionkey/examine(mob/user)
	...
	if(LAZYLEN(channels))
		...
		for(var/i in channels)
			examine_text_list += "[GLOB.channel_tokens[i]] - [r_lowertext(i)]"
...
/obj/item/encryptionkey/heads/captain
	name = "\proper the Proconsul's encryption key"
...
/obj/item/encryptionkey/heads/rd
	name = "\proper the Prefect Scientia's encryption key"
