...
/datum/map_template/ruin/space/asteroid4
	...
	name = "Asteroid 4"
	description = "Imperial Escape Pods have a 100%* success rate, and a 99%* customer satisfaction rate. \
...
/datum/map_template/ruin/space/derelict6
	...
	name = "Derelict 6"
	description = "The hush-hush of Empire when it comes to stations seemingly vanishing off the radar is an interesting topic, theories of nuclear destruction float about while Empire \
