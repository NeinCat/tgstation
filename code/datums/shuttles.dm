...
/datum/map_template/shuttle/emergency/russiafightpit
	...
	admin_notes = "Includes a small variety of weapons. And bears. Only Proconsul-access can release the bears. Bears won't smash the windows themselves, but they can escape if someone lets them."
