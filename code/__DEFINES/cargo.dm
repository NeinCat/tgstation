...
#define POD_STYLES list(\
    ...
    list("centcompod", "\improper CentCom supply pod", "A Empire supply pod, this one has been marked with Imperial Senate's designations. Teleports back to CentCom after delivery."),\
